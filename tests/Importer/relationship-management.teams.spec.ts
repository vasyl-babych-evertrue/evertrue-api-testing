...
/**
 * Test Suite: Relationship Management - Teams
 * 
 * Tests for managing Teams (Pools) in the Relationship Management system
 * 
 * Endpoints tested:
 * - GET /assignments-java/v2/pools - Get list of all teams
 * - GET /assignments-java/v2/stages - Get list of all stages
...
test.describe.serial('Relationship Management - Teams', () => {
  ...
  test('GET /assignments-java/v2/pools - Get list of all teams', async ({ request }) => {
    ...
    console.log('\nGet Teams Response Status:', response.status());
  ...
  test('GET /assignments-java/v2/stages - Get list of all stages', async ({ request }) => {
    const response = await request.get(
    ...
    console.log('\nGet Stages Response Status:', response.status());
